...
//        basicScrollView.addSubview(headerInfoView)
//        
//        headerInfoView.addSubview(detailHeaderView)
//        headerInfoView.addSubview(detailInfoTableView)
//
...
//        ]
//        
//        let headerInfoViewConstraints = [
//            headerInfoView.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 10),
//            headerInfoView.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -10),
//            headerInfoView.topAnchor.constraint(equalTo: contentView.topAnchor),
//            headerInfoView.bottomAnchor.constraint(equalTo: contentView.bottomAnchor)
//        ]
//        
//        let detailHeaderViewConstraints = [
//            detailHeaderView.leadingAnchor.constraint(equalTo: headerInfoView.leadingAnchor, constant: 15),
//            detailHeaderView.trailingAnchor.constraint(equalTo: headerInfoView.trailingAnchor, constant: -15),
//            detailHeaderView.topAnchor.constraint(equalTo: headerInfoView.topAnchor, constant: 15),
...
//            detailInfoTableView.leadingAnchor.constraint(equalTo: headerInfoView.leadingAnchor, constant: 15),
//            detailInfoTableView.trailingAnchor.constraint(equalTo: headerInfoView.trailingAnchor),
//            detailInfoTableView.topAnchor.constraint(equalTo: detailHeaderView.bottomAnchor),
//            detailInfoTableView.bottomAnchor.constraint(equalTo: headerInfoView.bottomAnchor)
//        ]
//        
...
//        NSLayoutConstraint.activate(headerInfoViewConstraints)
//        
//        DispatchQueue.main.async {
//            self.detailInfoTableView.getDetailInfoTableView().reloadData()
//            self.detailInfoTableView.getDetailInfoTableView().layoutIfNeeded()
//            self.detailInfoTableView.getDetailInfoTableView().heightAnchor.constraint(equalToConstant: self.detailInfoTableView.getDetailInfoTableView().contentSize.height).isActive = true
//        }
//    }
//    
//    
