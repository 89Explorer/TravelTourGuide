//
//  PlaceIntroduceCollectionViewCell.swift
//  TravelTourGuide
//
...
class PlaceIntroduceCollectionViewCell: UICollectionViewCell {
    
    // MARK: - VARIABLES
    static let identifier = "PlaceIntroduceCollectionViewCell"
    ...
    private let spotTitleLabel: UILabel = {
        ...
        label.font = UIFont(name: "Hakgyoansim Chulseokbu TTF B", size: 14)
        label.text = "전주 한옥 마을"
    ...
    private let ratingStarImageView: UIImageView = {
        ...
        imageView.tintColor = UIColor(named: "new-orange")
        return imageView
    }()
    ...
    private let ratingLabel: UILabel = {
        let label = UILabel()
        label.translatesAutoresizingMaskIntoConstraints = false
        label.font = UIFont(name: "Hakgyoansim Chulseokbu TTF B", size: 12)
        label.text = "4.5"
        label.numberOfLines = 1
        label.textColor = .black
        return label
