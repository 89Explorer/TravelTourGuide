...
class MainTableViewCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        basicView.addSubview(addressStackView)
    ...
    private func configureConstraints() {
        ...
        let addressStackViewConstraints = [
            addressStackView.leadingAnchor.constraint(equalTo: basicView.leadingAnchor, constant: 10),
            addressStackView.topAnchor.constraint(equalTo: maintitleLabel.bottomAnchor, constant: 12)
        ]
...
class MainTableViewCell: UITableViewCell {
    ...
    private func configureConstraints() {
        ...
        let mainStackViewConstraints = [
            mainStackView.leadingAnchor.constraint(equalTo: basicView.leadingAnchor, constant: 10),
